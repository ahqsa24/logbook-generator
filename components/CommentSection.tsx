                    ...
                    <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <select
                                ...
                                className="text-sm px-3 py-1.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400"
                            >
                        ...
                        <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
                            {getSortedComments().map((comment, index) => {
                                ...
                                return (
                                    <div key={commentIndex} className="space-y-3">
                                        {/* Main Comment */}
                                            ...
                                            <div className="flex items-start justify-between mb-2">
                                                <div className="flex-1">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <button
                                                            onClick={() => {
                                                                const newViewReplies = new Set(viewReplies);
                                                                if (newViewReplies.has(commentIndex)) {
                                                                    newViewReplies.delete(commentIndex);
                                                                    setReplyingTo(null); // Close reply form when hiding
                                                                } else {
                                                                    newViewReplies.add(commentIndex);
                                                                    setReplyingTo(commentIndex); // Open reply form when showing
                                                                }
                                                ...
                                                {isAdminMode && (
                                                    <button
                                                        ...
                                                        className="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 p-1 rounded hover:bg-red-50 dark:hover:bg-red-900/20 flex-shrink-0"
                                        ...
                                        {/* Reply Form - YouTube-inspired elegant design */}
                                        ...
                                        {/* Display Replies - YouTube-inspired elegant design */}
