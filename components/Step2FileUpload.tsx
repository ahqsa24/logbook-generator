...
import { useFileUpload } from './Step2FileUpload/hooks';
import { FileDropzone, ManualEntryCard } from './Step2FileUpload/components';
import type { Step2FileUploadProps } from './Step2FileUpload/types';
...
export default function Step2FileUpload({
    ...
    return (
        <div className="card dark:bg-gray-800 dark:border-gray-700">
            ...
            {/* Manual Entry Option */}
            <ManualEntryCard onManualEntry={onManualEntry} />
