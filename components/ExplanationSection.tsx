                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-3">
                                If you prefer using the command-line interface, check out the terminal version of this tool.
                            </p>
                            <a
                                href="https://github.com/Anro128/IPB-Student-Portal-Logbook-Bot"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 px-4 py-2.5 bg-green-600 dark:bg-green-700 hover:bg-green-700 dark:hover:bg-green-600 text-white rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                            >
